...
CREATE TABLE bd_actividad2.Alumno (
NumMatricula CHAR(3) ,
Nombre VARCHAR(15) ,
FechaNacimiento DATE ,
PRIMARY KEY (NumMatricula)
);
INSERT INTO bd_actividad2.alumno (NumMatricula, Nombre, FechaNacimiento)
VALUES('A5', 'Santos', '2002-5-20');
delete from bd_actividad2.alumno
where NumMatricula='a1';
delete from bd_actividad2.alumno;
select *
from bd_actividad2.Alumno;
...
-- todavía.
CREATE OR REPLACE TABLE bd_actividad2.alumno (
NumMatricula CHAR(3) ,
Nombre VARCHAR(15) ,
FechaNacimiento DATE ,
Teléfono CHAR(9) ,
...
DROP TABLE bd_actividad2.alumno ;
